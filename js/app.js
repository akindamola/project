	...
	function showQuestion(){
		test=callItem("test");
			if(position >= questions.length){
				...
				test.innerHTML= "<h9> You got " + correctAns + " of " + questions.length + " correct </h9>";
     			g("level").innerHTML="Quiz completed";
    				if (correctAns < 5){
    					test.innerHTML+= "<h6> Guess you over-hype your ability, your IQ is far below being a genius</h6>";
    				}
